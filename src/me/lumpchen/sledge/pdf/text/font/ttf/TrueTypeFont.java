...
public class TrueTypeFont {
	...
	public TrueTypeFont(int type) {
		...
		tables = Collections
				.synchronizedSortedMap(new TreeMap<String, Object>());
	}
	 ...
	 * 
	 * @param tagString
	 *            the name of this table, as a 4 character string (i.e. cmap or
	 *            head)
	 * @param data
	...
	/**
	 * Get a table by name. This command causes the table in question to be
	 * parsed, if it has not already been parsed.
	 * 
	 * @param tagString
	 *            the name of this table, as a 4 character string (i.e. cmap or
	 *            head)
	...
	private static void parseDirectories(ByteBuffer data, int numTables,
		...
		for (int i = 0; i < numTables; i++) {
			...
			if (calcChecksum == checksum) {
				 ...
				 * tagString + ": " + calcChecksum + " != " + checksum);
				 */
