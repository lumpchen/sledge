...
public class LocaTable extends TrueTypeTable {
	...
	/**
	 * get the offset, in bytes, of a given glyph from the start of the glyph
	 * table
	 */
	...
	/**
	 * Return true if the glyphs arte in long (int) format, or false if they are
	 * in short (short) format
	 */
