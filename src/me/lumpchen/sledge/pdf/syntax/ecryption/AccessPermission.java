...
public class AccessPermission {
	...
	private static final int DEFAULT_PERMISSIONS = 0xFFFFFFFF ^ 3;
	...
	/**
	 * Create a new access permission object from a byte array. Bytes are
	 ...
	 * can be used for public key encryption. This format is not documented in
	 * the PDF specifications but is necessary for compatibility with Adobe
	...
	/**
	 * Set if the user can modify the document. This method will have no effect
	...
	/**
	 * Set if the user can extract content from the document. This method will
	 * have no effect if the object is in read only mode
	 * 
	...
	/**
	 * This will tell if the user can add/modify text annotations, fill in
	...
	/**
	 * Set if the user can modify annotations. This method will have no effect
	 * if the object is in read only mode
	 * 
	...
	/**
	 * Set if the user can fill in interactive forms. This method will have no
	 * effect if the object is in read only mode
	 * 
	 * @param allowFillingInForm
	 *            A boolean determining if the user can fill in interactive
	 *            forms.
	 */
	 ...
	 * purposes. This method will have no effect if the object is in read only
	 * mode
	 * 
	 * @param allowExtraction
	 *            A boolean determining if the user can extract content from the
	...
	/**
	 * Set if the user can insert/rotate/delete pages. This method will have no
	 * effect if the object is in read only mode
	 * 
	 * @param allowAssembly
	...
	/**
	 * Set if the user can print the document in a degraded format. This method
	 * will have no effect if the object is in read only mode
	 * 
	 * @param allowAssembly
