...
public class GlyfSimple extends Glyf {
	...
	/**
	 * Get the data in this glyf as a byte buffer. Return the basic glyf data
	 * only, since there is no specific data. This method returns the data
	...
	/**
	 * Determine whether the x value for the given point is byte or short. If
	 * true, it is a byte, if false it is a short
	 */
	...
	/**
	 * Determine whether the x value for the given point is the same as the
	 * previous value.
	 */
	...
	/**
	 * Determine whether the y value for the given point is the same as the
	 * previous value.
	 */
