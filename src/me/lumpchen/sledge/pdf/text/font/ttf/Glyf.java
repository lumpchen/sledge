...
public class Glyf {
	...
	/**
	 * Set the data for this glyf. Do nothing, since a glyf with no contours has
	 * no glyf data.
	 */
	...
	/**
	 * Get the length of this glyf. A glyf with no data has a length of 10 (2
	 * bytes each for 5 short values)
	 */
