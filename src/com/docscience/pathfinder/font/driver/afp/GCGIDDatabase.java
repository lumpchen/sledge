...
/**
 * This class map IBM Graphic Character Global Identifier (GCGID) to Unicode
 * based on <a
 * href="http://www-01.ibm.com/software/globalization/gcgid/gcgid.jsp">IBM GCGID
 * Table</a>.
 * 
 * @author wxin
 * 
 */
public final class GCGIDDatabase {

	private static final int NOT_DEFINED_UNICODE = -1;
	
	private static final Map<String, Integer> unicodeMap;
	...
	static {
		...
		unicodeMap = new HashMap<String, Integer>();
	...
	public static int getUnicode(String gcgid) {
		Integer i = unicodeMap.get(gcgid);
		if (i != null) {
			return i.intValue();
		}
