...
public abstract class CMap {
	 ...
	 * 
	 * <p>
	 * The Macintosh standard character to glyph mapping is supported by format
	 * 0.
	 * </p>
	 * 
	 * <p>
	 ...
	 * 16/32-bit and pure 32-bit mappings.<br>
	...
	public static CMap createMap(short format, short language) {
		...
		// // defines a trimmed array for a tight range of 32-bit character
		// codes:
		// case 10:
	...
	public String toString() {
		...
		return indent + " format: " + getFormat() + " length: " + getLength()
