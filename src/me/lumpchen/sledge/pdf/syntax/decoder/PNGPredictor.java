...
public class PNGPredictor extends Predictor {
	...
	/**
	 * Return the value of the up algorithm on the line (compare bytes to the
	 * same byte in the previous line)
	 */
	...
	/**
	 * Return the value of the average algorithm on the line (compare bytes to
	 * the average of the previous byte of the same color and the same byte on
	 * the previous line)
	 */
