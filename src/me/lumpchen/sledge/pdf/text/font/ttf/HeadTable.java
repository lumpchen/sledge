...
public class HeadTable extends TrueTypeTable {
	...
	/**
	 * Creates a new instance of HeadTable Makes up reasonable(?) defaults for
	 * all values
	 */
	protected HeadTable() {
	...
	public String toString() {
		...
		buf.append(indent + "Revision         : "
				+ Integer.toHexString(getFontRevision()) + "\n");
		buf.append(indent + "ChecksumAdj      : "
				+ Integer.toHexString(getChecksumAdjustment()) + "\n");
		buf.append(indent + "MagicNumber      : "
				+ Integer.toHexString(getMagicNumber()) + "\n");
		buf.append(indent + "Flags            : "
		...
		buf.append(indent + "MacStyle         : "
				+ Integer.toBinaryString(getMacStyle()) + "\n");
